...
const AboutMe = ({ isDarkMode }) => {
  return (
    <section id="about me" className={`pt-6 md:pt-10 pb-16 md:pb-32 relative transition-colors duration-300 ${isDarkMode ? 'bg-transparent' : 'bg-transparent'} overflow-hidden`}>
      {isDarkMode && (
